...
namespace RosSharp.std_msgs
{
    public class MultiArrayLayout : IMessage
    {
        ...
        {
            get { return "3ac8ba00ff694a6809987e580cbbb792"; }
        }
        ...
        {
            dim = new List<MultiArrayDimension>(br.ReadInt32()); for(int i=0; i<dim.Count; i++) { dim[i] = new MultiArrayDimension();}
            data_offset = br.ReadUInt32();
        }
        public int SerializeLength
        {
            get { return dim.Sum(x => x.SerializeLength) + 4; }
        }
