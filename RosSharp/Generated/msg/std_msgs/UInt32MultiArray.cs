...
{
    public class UInt32MultiArray : IMessage
    {
        ...
        public UInt32MultiArray(BinaryReader br)
        {
            Deserialize(br);
        }
        ...
        {
            get { return "0cd20e8434ba52c6000050237185670f"; }
        }
        ...
        {
            layout = new MultiArrayLayout();
            data = new List<uint>(br.ReadInt32()); for(int i=0; i<data.Count; i++) { data[i] = br.ReadUInt32();}
        }
        public int SerializeLength
        {
            get { return layout.SerializeLength + data.Sum(x => 4); }
        }
        public bool Equals(UInt32MultiArray other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj.GetType() != typeof(UInt32MultiArray)) return false;
            return Equals((UInt32MultiArray)obj);
        }
