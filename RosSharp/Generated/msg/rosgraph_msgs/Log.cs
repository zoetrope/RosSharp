...
namespace RosSharp.rosgraph_msgs
{
    ...
    public class Log : IMessage
    {
        ...
        public bool Equals(Log other)
        {
            ...
            return other.header.Equals(header) && other.level.Equals(level) && other.name.Equals(name) && other.msg.Equals(msg) && other.file.Equals(file) && other.function.Equals(function) && other.line.Equals(line) && other.topics.SequenceEqual(topics);
        }
        ///<exclude/>
